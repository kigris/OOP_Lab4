...
Park* getPark(VacationPark& vp, int index, bool editMode=false);
...
bool updateBooking(VacationPark& vp, Booking* booking, Accomodation* accomodation, bool parkReference=false);
